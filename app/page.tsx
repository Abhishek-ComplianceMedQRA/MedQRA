        ...
        <div className="mx-auto max-w-5xl px-4 text-center md:px-6">
          ...
          <div className="rounded-2xl border border-border bg-card p-8 shadow-lg">
            ...
            <p className="mb-6 text-xl italic text-foreground">
              "ComplianceMedQRA's AI capabilities have transformed how we manage our regulatory compliance. The platform
              is intuitive, comprehensive, and has saved us countless hours in preparation for audits. The AI-powered
              document analysis has been a game-changer for our team."
            </p>
            <div>
              <p className="font-semibold text-foreground">Sarah Johnson</p>
              <p className="text-muted-foreground">Quality Assurance Director, MedTech Innovations</p>
            </div>
          </div>
        </div>
      </section>
